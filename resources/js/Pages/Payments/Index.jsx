...
export default function Index({ payments, queryParams = null, success }) {
    ...
    const searchFieldChange = (description, value) => {
        ...
        router.get(route("payment.index"), queryParams);
    };
    ...
    const handleSortChange = (field, direction = null) => {
        ...
        router.get(route("payment.index"), newParams);
    };
    ...
    const confirmDelete = () => {
        ...
        router.visit(route("payment.destroy", invoiceToDelete.id), {
            method: "delete",
            preserveScroll: true,
            preserveState: false,
        });
                ...
                <div className="flex justify-between items-center gap-4">
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">
                            Organize payments for all of your tenants
                        </p>
                    </div>
